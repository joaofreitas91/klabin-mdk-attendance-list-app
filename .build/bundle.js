...
async function QueryCursos(clientAPI) {
    ...
    // let cFilter = `$filter=cust_InstrutorNav/externalCode eq '${ExtCode}' or cust_InstrutorNav/cust_RELATED_USER eq '${SFUser}' or cust_InstrutorNav/externalCode eq '${ExtCode}' or cust_InstrutorNav/cust_RELATED_USER eq '${SFUser}' or cust_instrutor eq null`
    return cFilter
}
